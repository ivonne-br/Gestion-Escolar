...
<body>
  ...
  <div class="wrapper">
    <div class="menu-panel full-width">
      <a href="/GestionEscolar/public/alumnos/formulario" class="menu-opcion">➕ Registrar Nuevo Alumno</a>
      <a href="/GestionEscolar/public/alumnos/index" class="menu-opcion">📋 Ver Lista de Alumnos</a>
    </div>
